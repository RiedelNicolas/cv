...
#job(
  ...
  description: [
    ...
    - #strong[Managed the mobile implementation] of an #strong[Online Booking Tool (OBT)], architecting the mobile frontend and its integration with gateway services for major enterprise clients across Latin America.
    - Improved development efficiency and app stability by implementing #strong[automated builds (CI/CD)], #strong[OTA updates], automated testing, and #strong[Google Analytics] for data-driven product decisions.
